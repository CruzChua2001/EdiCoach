    ...
    return (
        <FooterDiv className="row">
            ...
            <div className="col-12 col-sm-6 col-md-3">
                ...
                <Links>
                    <p><LinkTag href="/coach">Appointments</LinkTag></p>
                    <p><LinkTag href="/coach/client">Clients</LinkTag></p>
                    <p><LinkTag href="/coach/contact">Contact Us</LinkTag></p>
                    <p><LinkTag href="/coach/FAQ">FAQ</LinkTag></p>
                </Links>
            </div>
            <div className="col-12 col-sm-6 col-md-3">
